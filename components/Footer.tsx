export default function Footer() {
  return (
    <footer className="border-t border-[#1a1a2e] py-16 px-6 text-center">
      <p
      ...
      >
        Established 1883 &middot; Gobbler&apos;s Knob, Pennsylvania
      </p>
      ...
      <p
        className="mt-6 text-xs text-[#e8e6e3]/60 italic"
        style={{ fontFamily: "var(--font-mono)" }}
      >
      ...
      <p
        className="mt-8 text-xs text-[#666666]"
        style={{ fontFamily: "var(--font-mono)" }}
      >
        &copy; 2026 Groundhoge Day Economic Authority. All shadows reserved.
      </p>
    </footer>
  );
}
