...
const PROPHECIES: string[] = [
  ...
  "DECREE: The Oracle has been informed that a coin flip has a higher accuracy rate. The Oracle does not recognize the coin flip as a legitimate meteorological instrument. The coin lacks gravitas.",
  ...
  "ADVISORY: The Inner Circle has received inquiries about the Oracle's 39% accuracy rate. The Inner Circle's position remains: 100%. The 61% discrepancy is a translation issue. The acacia cane is old.",
  ...
  "BULLETIN: The frostbite penalty for early withdrawal from hibernation staking is 40%. This reflects the Oracle's actual accuracy rate. The Inner Circle insists this is a coincidence.",
